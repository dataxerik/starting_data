...
def shortest_paths_from(from_user):
    # a dictionary form "user_id" to *all* shortest paths to that user
    shortest_paths_to = {from_user["id"]: [[]]}

    # a queue of (previous user, new user) that we need to check.
    ...
    while frontier:
        ...
        # the face that we're pulling from our queue means that
        ...
        # add new neighbor to the frontier
...
for user in users:
    user["endorses"] = []       # add one list ot track outgoing endorsements
    user["endorsed_by"] = []    # and another to track endorsements

for sourc_id, target_id in endorsements:
