...
from linear_algebra import shape, get_column, make_matrix, magnitude, dot, vector_sum, scalar_multiply, vector_subtract
from statistics import correlation, mean, standard_deviation
from gradient_descent import maximize_batch, maximize_shochastic
...
def day_over_day_changes(grouped_rows):
    ...
    return [{'symbol': today['symbol'],
             'date': today['date'],
             'change': precent_price_change(yesterday, today)}
...
def directional_variance_gradient_i(x_i, w):
    """The contribution of row x_i to the graident of
...
if __name__ == "__main__":
    ...
    print(Y)
    # components =
    print(first_principal_component(Y))
